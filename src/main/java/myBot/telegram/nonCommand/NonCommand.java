...
public class NonCommand {
    private Logger logger = (Logger) LoggerFactory.getLogger(NonCommand.class);
    ...
    private Settings createSettings(String text) throws IllegalArgumentException {
        ...
        if (parameters.length != 3) throw new IllegalArgumentException((String.format("Не удалось разбить сообщение \"%s\" на 3 составляющих",
                text)));
